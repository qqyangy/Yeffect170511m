...
define(function () {
  ...
  var widget = require("./widget").widget;
                            ...
                            if (k == b && i == a) {
                                ...
                                switch (j.attr("type")) {
                                    ...
                                    case "papp":
                                        ...
                                        if(Math.abs(gettime-clicktype)>300 && false){
                                          j.addClass("hover");
                                          clicktype=gettime;
                                        }else{
                                          j.removeClass("hover");
    ...
    var delRepetApendapp={id:-1,now:0};
            ...
            create: function (d, a, _x, _y,ico) {
                ...
                if (c == false) {
                    if (a == "folder") {
                        ...
                        //$.getJSON(ajaxUrl + "?ac=getMyAppById&id=" + d + "&type=" + a, function(e) {
                      var now_=Date.now();
                      if(delRepetApendapp.id==d && now_-delRepetApendapp.now<1000*10){return;}/****防止快速重复点击打开***/
                      msgboxshow("应用正在加载中，请耐心等待...", 6, 10000);
                      delRepetApendapp.id=d;
                      delRepetApendapp.now=now_;
                        $.ajax({
                            type: 'GET',
                            //contentType: "application/json",
                            dataType: "json",
                          ...
                          delRepetApendapp.id=-1;
                          delRepetApendapp.now=0;
                          //delRepetApendapp.id=-1;
        ...
        return {
            ...
            windowresize: function () {
                $("#desk div.window-container").each(function () {
                    ...
                    currentH = $('#desk').height() - $(this).height();
                ...
                $.ajax({
                    ...
                    success: function (b) {
                        ...
                        if (b.code == 0) {
                            ...
                            /*******桌面壁纸*********/
                          if (typeof(window.setWallpaper) != "undefined") {
                            CONFIG.wallpaper = b.result.wallpaper.url;
                            CONFIG.wallpaperType = b.result.wallpaper_style;
                            localStorage.wallpaperUrl=CONFIG.wallpaper;
                            window.setWallpaper();/***在wallpaer.js中赋予的全局方法，设置壁纸****/
                          }
