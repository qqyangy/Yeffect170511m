...
(function (g, h) {
    ...
    if (g.$ === h) g.$ = c;
    c.fn = c.prototype = {
        constructor: c, ready: function (b) {
            c.bindReady();
    ...
    c.event = {
        add: function (b, d, e) {
            ...
            var c = {
                target: b.srcElement || document, preventDefault: function () {
                    b.returnValue = !1
...
(function (g, h, n) {
    ...
    b.fn = b.prototype = {
        version: "4.1.6", closed: !0, _init: function (a) {
    ...
    b._templates = '<div class="aui_outer"><table class="aui_border"><tbody><tr><td class="aui_nw"></td><td class="aui_n"></td><td class="aui_ne"></td></tr><tr><td class="aui_w"></td><td class="aui_c"><div class="aui_inner"><table class="aui_dialog"><tbody><tr><td colspan="2" class="aui_header"><div class="aui_titleBar"><div class="aui_title"></div><a class="aui_close" href="javascript:;">\u00d7</a></div></td></tr><tr><td class="aui_icon"><div class="aui_iconBg"></div></td><td class="aui_main"><div class="aui_content"></div></td></tr><tr><td colspan="2" class="aui_footer"><div class="aui_buttons"></div></td></tr></tbody></table></div></td><td class="aui_e"></td></tr><tr><td class="aui_sw"></td><td class="aui_s"></td><td class="aui_se"></td></tr></tbody></table></div>';
    b.defaults = {
...
(function (g) {
    ...
    artDialog.dragEvent.prototype = {
        onstart: g.noop, start: function (g) {
